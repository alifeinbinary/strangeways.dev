      ...
      <div className="container-responsive">
        <div className="mb-8 max-w-3xl">
          ...
          <p className="mt-3 text-neutral-600 dark:text-neutral-300">
            We help medium to large organisations, venture-backed start-ups, and
            agencies reduce tech costs, avoid vendor lock-in, and ship
            high-performance software with confidence.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <aside className="lg:col-span-4">
            <div className="card sticky top-16 rounded-xl border border-neutral-200 p-5 dark:border-neutral-800">
              <h3 className="text-sm font-semibold uppercase tracking-wide text-neutral-800 dark:text-neutral-400">
                Why Strangeways
              </h3>
              <ul className="text-sm mt-4 space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="font-semibold">18+ years</strong> of
                    hands-on web engineering and infrastructure.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span
                  ...
                  <span>
                    <strong className="font-semibold">Performance-first</strong>{' '}
                    delivery with modern stacks and rigorous fundamentals.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span
                  ...
                  <span>
                    ...
                    via serverless and open-source where it fits.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span
                  ...
                  <span>
                    <strong className="font-semibold">Engagements</strong> on
                    retainer or hourly (2h minimum).
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="lg:col-span-8">
              ...
              >
                <Masonry>
                  {services.map((service) => (
                    ...
                    >
                      <div className="relative mb-0 h-fit cursor-pointer rounded-xl border border-neutral-200 p-5 transition-colors duration-500 hover:bg-brand-50 dark:border-neutral-800 dark:hover:bg-neutral-900">
                        <div
            ...
            >
              ...
              <p className="text-sm mt-2 text-neutral-600 dark:text-neutral-300">
                Choose the engagement that fits your team and timeline.
              </p>
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {howWeWorkItems.map((item) => (
                  <article
                    key={item.id}
                    className="group relative cursor-pointer rounded-lg border border-neutral-200 p-4 transition-colors duration-500 hover:bg-brand-50 dark:border-neutral-800 dark:hover:bg-neutral-900"
                    onClick={(e) => {
                      e.preventDefault()
                      toggleCard(item.id)
                    }}
            ...
            >
              ...
              <ol className="text-sm mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                <li>

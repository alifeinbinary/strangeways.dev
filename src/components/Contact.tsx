...
export default function Contact() {
    function ObfuscatedEmail() {
        ...
        return (
            <a
                href={href}
                className="shadow-subtle focus:ring-brand-500/30 inline-flex items-center justify-center gap-2 rounded-md border border-neutral-200 bg-white px-4 py-2 text-sm font-medium text-neutral-900 transition hover:bg-neutral-50 focus:ring-2 focus:ring-offset-0 focus:outline-none dark:border-neutral-800 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800"
            >
                <span>
                    {user}[at]{domain}
                </span>
        ...
        <section id="contact" className="container-responsive cv-auto py-8">
            <div className="mb-8 max-w-3xl">
                ...
                <p className="mt-3 text-neutral-600 dark:text-neutral-300">
                    We offer a free 15-minute consultation to discuss your
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                >
                    ...
                    <a
                        ...
                        className="shadow-subtle focus:ring-brand-500/30 mt-2 inline-flex items-center justify-center gap-2 rounded-md border border-neutral-200 bg-white px-4 py-2 text-sm font-medium text-neutral-900 transition hover:bg-neutral-50 focus:ring-2 focus:ring-offset-0 focus:outline-none dark:border-neutral-800 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800"
                    >
                        Pay Invoice
                    </a>
                </article>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <input
                                        ...
                                        className="form-input shadow-subtle focus:border-brand-500 focus:ring-brand-500/30 w-full rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-900 transition placeholder:text-neutral-400 focus:ring-2 focus:outline-none dark:border-neutral-800 dark:bg-neutral-950 dark:text-white"
                            ...
                            <div className="flex items-center justify-end">
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="bg-brand-600 shadow-subtle hover:bg-brand-700 focus:ring-brand-500/30 inline-flex cursor-pointer items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-white transition focus:ring-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-70"
                                >

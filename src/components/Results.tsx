                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    >
                        ...
                        <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-300">
                            Consolidated tooling with self-hosted services and
                            SSO while maintaining reliability and
                            supportability.
                        </p>
                    ...
                    >
                        ...
                        <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-300">
                            Deployed agentic AI with retrieval, guardrails, and
                            persistent memory to automate triage and routine
                            ops.
                        </p>
                        <ul className="mt-3 list-inside list-disc text-sm text-neutral-700 dark:text-neutral-200">
                            <li>
                                <strong>-34%</strong> time to resolution with
                                human-in-the-loop
                            </li>
                    ...
                    >
                        ...
                        <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-300">
                            Delivered secure, observable web applications with
                            CI/CD and cost-aware architectures from day one.
                        </p>
                        <ul className="mt-3 list-inside list-disc text-sm text-neutral-700 dark:text-neutral-200">
                            <li>
                                <strong>99.95%</strong> availability, sub-200ms
                                median
                            </li>
